...
<template>
  <div class="bg-tertiary w-svw flex justify-center px-4">
    <div
      class="w-full max-w-max flex gap-4 max-h-screen overflow-clip items-start"
    ...
    >
      <div class="flex flex-col pt-10 gap-8 h-fit mr-auto" :style="textContainerStyle">
        ...
        <p class="text-secondary font-normal">
          ...
          individualidade e atender o seu senso de estilo
        </p>
        <button
        ...
        <div class="flex pt-4 pb-10 mr-auto ml-auto">
          ...
          <div class="flex flex-col gap-2 px-8 border-x-2">
